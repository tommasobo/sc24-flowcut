...
#define LT_DLSEARCH_PATH "/lib64:/usr/lib64:/lib:/usr/lib:/usr/lib/x86_64-linux-gnu/libfakeroot:/usr/lib/wsl/lib:/usr/local/lib:/usr/local/lib/x86_64-linux-gnu:/lib/x86_64-linux-gnu:/usr/lib/x86_64-linux-gnu"
...
#define PACKAGE_STRING "SSTCore 11.0.0"
...
#define SSTCORE_GIT_HEADSHA "11.0.0"
...
#define SST_CPPFLAGS "-I$(top_builddir) -I$(top_srcdir)/src -I$(top_builddir)/src "
...
#define SST_INSTALL_PREFIX "/home/tbonato/local/sstcore-11.1.0"
...
#define SST_MPICXX "mpic++"

/* Defines the CPPFLAGS needed to compile Python into SST */
#define SST_PYTHON_CPPFLAGS "-I/usr/include/python3.8 -I/usr/include/python3.8"

/* Defines the LDFLAGS needed to compile Python into SST */
#define SST_PYTHON_LDFLAGS "-L/usr/lib/python3.8/config-3.8-x86_64-linux-gnu -L/usr/lib -lpython3.8 -lcrypt -lpthread -ldl  -lutil -lm -lm "
