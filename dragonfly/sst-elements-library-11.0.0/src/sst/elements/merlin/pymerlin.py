...
#        print("Total hosts: " + str(self.total_hosts))
        ...
        print("Total Number host is " + str(self.total_hosts))
        print("\nTotal hosts -> " + str(self.total_hosts))
        print("\nTotal up -> " + str(self.ups))
        print("\nTotal down -> " + str(self.downs) + "\n")
        print("\nRouter per level")
        for it in self.routers_per_level:
            print(str(it) + " ")
        print("\n")
        print("\nGroup per level")
        for it in self.groups_per_level:
            print(str(it) + " ")
        print("\n")
...
class topoDragonFly(Topo):
    def __init__(self):
        Topo.__init__(self)
        self.topoKeys = ["topology", "debug", "num_ports", "flit_size", "link_bw", "xbar_bw", "dragonfly:hosts_per_router", "dragonfly:routers_per_group", "dragonfly:intergroup_per_router", "dragonfly:num_groups","dragonfly:intergroup_links","input_latency","output_latency","input_buf_size","output_buf_size","dragonfly:route_adaptive_local","dragonfly:routing", "dragonfly:flowlet_timeout", "dragonfly:ackMode", "dragonfly:flowcut_mode", "dragonfly:flowcut_value", "dragonfly:flowcut_max_ratio", "dragonfly:exponential_alpha"]
...
#        _params["router_radix"] = int(_params["router_radix"])
        ...
        _params["dragonfly:route_adaptive_local"] = self.global_routes
        ...
        print("Total Intergroup Links -> " + str(self.total_intergroup_links))
        print("Global Links Per Router -> " + str(_params["dragonfly:intergroup_per_router"]))
        print("Empty Ports -> " + str(self.empty_ports))
    ...
    def build(self):
        ...
        swap_keys = [("dragonfly:hosts_per_router","hosts_per_router"),("dragonfly:routers_per_group","routers_per_group"),("dragonfly:intergroup_links","intergroup_links"),("dragonfly:num_groups","num_groups"),("dragonfly:intergroup_per_router","intergroup_per_router"),("dragonfly:algorithm","algorithm"),("dragonfly:route_adaptive_local","route_adaptive_local"),("dragonfly:adaptive_threshold","adaptive_threshold"),("dragonfly:routing","routing"), ("dragonfly:flowlet_timeout","flowlet_timeout"), ("dragonfly:ackMode","ackMode"),  ("dragonfly:flowcut_mode","flowcut_mode"), ("dragonfly:flowcut_value","flowcut_value"), ("dragonfly:flowcut_max_ratio","flowcut_max_ratio"), ("dragonfly:exponential_alpha","exponential_alpha")]
