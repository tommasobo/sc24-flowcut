...
class topoFatTree(Topology):
    ...
    def __init__(self):
        ...
        self._declareClassVariables(["link_latency","host_link_latency","bundleEndpoints","_ups","_downs","_routers_per_level","_groups_per_level","_start_ids",
                                     "_total_hosts"])
        self._declareParams("main",["shape","routing_alg","adaptive_threshold", "algorithm"])        
    ...
    def _shape_callback(self,variable_name,value):
        ...
        print("\nTotal hosts -> " + str(self._total_hosts))
        print("\nTotal up -> " + str(self._ups))
        print("\nTotal down -> " + str(self._downs) + "\n")
        for it in self._routers_per_level:
            print(it + " ")
        print("\n")
        for it in self._groups_per_level:
            print(it + " ")
        print("\n")
