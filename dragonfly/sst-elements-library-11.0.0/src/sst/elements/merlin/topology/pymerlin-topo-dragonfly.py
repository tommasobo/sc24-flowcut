...
class topoDragonFly(Topology):
    ...
    def __init__(self):
        ...
        self._declareParams("main",["hosts_per_router","routers_per_group","intergroup_links","num_groups",
                                    ...
                                    "failed_links", "routing", "flowlet_timeout", "dragonfly:flowlet_timeout","dragonfly:ackMode","dragonfly:routing"])
    ...
    def setShape(self,hosts_per_router, router_per_group, intergroup_links, num_groups):
        ...
        self.routers_per_group = router_per_group
    ...
    def build(self, endpoint):
        ...
        print("Total Intergroup Links -> " + str(total_intergroup_links))
        print("Global Links Per Router -> " + str(intergroup_per_router))
