...
class FattreeInfo(TopoInfo):
    ...
    def calcNumNodes(self, shape):
        ...
        for l in levels:
            ...
            print("\Host " + str(l) + " -> " + str(total_hosts * int(links[0])) + "\n")
...
class DragonFlyInfo(TopoInfo):
    def __init__( self, param, customRouting, defaultRoutingAlgo, flowletTimeout, ackMode, flowcut_mode, flowcut_value, flowcut_max_ratio, exponential_alpha):
        self.params = {}
        self.routingAlgo = customRouting
        self.flowletTimeout = flowletTimeout
        self.defaultRoutingAlgo = defaultRoutingAlgo
        self.ackMode = ackMode
        self.flowcut_mode = flowcut_mode
        self.flowcut_value = flowcut_value
        self.flowcut_max_ratio = flowcut_max_ratio
    ...
    def initV1( self, shape ):
        ...
        self.params["dragonfly:num_groups"] =  nGrp
        self.params["dragonfly:algorithm"] =  self.defaultRoutingAlgo
        self.params["dragonfly:routing"] =  self.routingAlgo
        self.params["dragonfly:flowlet_timeout"] =  self.flowletTimeout
        self.params["dragonfly:ackMode"] =  self.ackMode
        self.params["dragonfly:flowcut_mode"] =  self.flowcut_mode
        self.params["dragonfly:flowcut_value"] =  self.flowcut_value
        self.params["dragonfly:flowcut_max_ratio"] =  self.flowcut_max_ratio
        self.params["dragonfly:exponential_alpha"] =  self.exponential_alpha
        print("alpha is " + str(self.params["dragonfly:exponential_alpha"]))
        print("ratio is " + str(self.params["dragonfly:flowcut_max_ratio"]))
