...
#include "emberallpingpongcustom.h"

using namespace SST::Ember;

#define TAG 0xDEADBEEF

EmberAllPingPongCustomGenerator::EmberAllPingPongCustomGenerator(SST::ComponentId_t id,
                                            Params& params) :
	EmberMessagePassingGenerator(id, params, "AllPingPongCustom"),
    m_loopIndex(0)
{
...
bool EmberAllPingPongCustomGenerator::generate( std::queue<EmberEvent*>& evQ)
{
    printf("I am here\n"); fflush(stdout);
