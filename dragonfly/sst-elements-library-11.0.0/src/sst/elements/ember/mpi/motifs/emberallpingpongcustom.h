...
#ifndef _H_EMBER_ALL_PINGPONGCUSTOM_MOTIF
#define _H_EMBER_ALL_PINGPONGCUSTOM_MOTIF
...
class EmberAllPingPongCustomGenerator : public EmberMessagePassingGenerator {

public:
    SST_ELI_REGISTER_SUBCOMPONENT_DERIVED(
        EmberAllPingPongCustomGenerator,
        "ember",
        "AllPingPongCustomMotif",
...
public:
	EmberAllPingPongCustomGenerator(SST::ComponentId_t, Params& params);
