...
#ifndef _H_EMBER_RANDOMCUSTOMBG_GEN
#define _H_EMBER_RANDOMCUSTOMBG_GEN
...
class EmberRandomBgTrafficGenerator : public EmberMessagePassingGenerator {

public:
    SST_ELI_REGISTER_SUBCOMPONENT_DERIVED(
        EmberRandomBgTrafficGenerator,
        "ember",
        "RandomBgMotif",
...
public:
	EmberRandomBgTrafficGenerator(SST::ComponentId_t, Params& params);
