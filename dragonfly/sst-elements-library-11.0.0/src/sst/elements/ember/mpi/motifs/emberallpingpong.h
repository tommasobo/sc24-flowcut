...
private:
    ...
    MessageRequest m_req2;
    MessageRequest* msgRequests;
    MessageRequest m_req3;
    MessageRequest m_req4;
    MessageRequest m_req5;
    MessageRequest m_req6;
    MessageRequest m_req7;
    MessageRequest m_req8;
    MessageRequest m_req9;
    void*    m_sendBuf;
    void*    m_sendBuf1;
    void*    m_sendBuf2;
    void*    m_recvBuf;
