...
#ifndef _H_EMBER_BERT_MOTIF
#define _H_EMBER_BERT_MOTIF
...
class EmberBertGenerator : public EmberMessagePassingGenerator {
...
public:
	EmberBertGenerator(SST::ComponentId_t, Params& params);
