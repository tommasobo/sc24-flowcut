...
#ifndef _H_EMBER_ALL_PINGPONGCUSTOMBIG_MOTIF
#define _H_EMBER_ALL_PINGPONGCUSTOMBIG_MOTIF
...
class EmberAllPingPongCustomBigGenerator : public EmberMessagePassingGenerator {

public:
    SST_ELI_REGISTER_SUBCOMPONENT_DERIVED(
        EmberAllPingPongCustomBigGenerator,
        "ember",
        "AllPingPongCustomBigMotif",
...
public:
	EmberAllPingPongCustomBigGenerator(SST::ComponentId_t, Params& params);
