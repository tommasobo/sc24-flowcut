...
#ifndef _H_EMBER_ALLREDUCERESNET_MOTIF
#define _H_EMBER_ALLREDUCERESNET_MOTIF
...
class EmberAllreduceResnetGenerator : public EmberMessagePassingGenerator {

public:
    SST_ELI_REGISTER_SUBCOMPONENT_DERIVED(
        EmberAllreduceResnetGenerator,
        "ember",
        "AllreduceResnetMotif",
...
public:
	EmberAllreduceResnetGenerator(SST::ComponentId_t, Params& params);
