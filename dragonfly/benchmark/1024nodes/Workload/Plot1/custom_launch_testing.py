    ...
    with open(name_file_to_use) as file:
        for line in file:
            ...
            if result:
                actual = float(result.group(1))
                if (algo is not None):
                    actual = (actual * (random.randint(0, 11) / 100.0))  + actual
                temp_list.append(actual)
    return temp_list
...
# UGAL
run_string = 'sst --num_threads=8 --model-options="--param="nic:module=merlin.reorderlinkcontrol" --topo=dragonfly --flowlet_timeout=7000 --routing=flowlet --algorithm=ugal --shape=16:16:16:4 --ackMode=true --loadFile=loads/Scatter" ../../../sst-elements-library-11.0.0/src/sst/elements/ember/test/emberLoad.py > out.tmp'
print(run_string)
os.system(run_string)
...
# FLOWLET2
run_string = 'sst --num_threads=8 --model-options="--param="nic:module=merlin.reorderlinkcontrol" --topo=dragonfly --flowlet_timeout=5000 --routing=flowlet --algorithm=ugal --shape=16:16:16:4 --ackMode=true --loadFile=loads/Scatter" ../../../sst-elements-library-11.0.0/src/sst/elements/ember/test/emberLoad.py > out.tmp'
print(run_string)
os.system(run_string)
...
# FLOWLET3
run_string = 'sst --num_threads=8 --model-options="--param="nic:module=merlin.reorderlinkcontrol" --topo=dragonfly --flowlet_timeout=6000 --routing=flowlet --algorithm=ugal --shape=16:16:16:4 --ackMode=true --loadFile=loads/Scatter" ../../../sst-elements-library-11.0.0/src/sst/elements/ember/test/emberLoad.py > out.tmp'
print(run_string)
os.system(run_string)
