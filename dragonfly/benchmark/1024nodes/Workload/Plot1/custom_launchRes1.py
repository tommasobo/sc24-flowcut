...
# FLOWLET1
run_string = 'sst --num_threads=8 --model-options="--param="nic:module=merlin.reorderlinkcontrol" --topo=dragonfly --flowlet_timeout=300 --routing=flowlet --algorithm=ugal --shape=16:16:16:4 --ackMode=true --loadFile=loads/Scatter" ../../../sst-elements-library-11.0.0/src/sst/elements/ember/test/emberLoad.py > out.tmp'
print(run_string)
os.system(run_string)
...
# FLOWLET2
run_string = 'sst --num_threads=8 --model-options="--param="nic:module=merlin.reorderlinkcontrol" --topo=dragonfly --flowlet_timeout=500 --routing=flowlet --algorithm=ugal --shape=16:16:16:4 --ackMode=true --loadFile=loads/Scatter" ../../../sst-elements-library-11.0.0/src/sst/elements/ember/test/emberLoad.py > out.tmp'
print(run_string)
os.system(run_string)
...
# FLOWLET3
run_string = 'sst --num_threads=8 --model-options="--param="nic:module=merlin.reorderlinkcontrol" --topo=dragonfly --flowlet_timeout=1000 --routing=flowlet --algorithm=ugal --shape=16:16:16:4 --ackMode=true --loadFile=loads/Scatter" ../../../sst-elements-library-11.0.0/src/sst/elements/ember/test/emberLoad.py > out.tmp'
print(run_string)
os.system(run_string)
