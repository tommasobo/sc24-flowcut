...
slingshot = [244.2, 251.2, 262.6, 272.2, 285.27]
slingshot_1 = [238.2, 250.2, 256.6, 262.2, 272.27]
slingshot_2 = [234.2, 246.2, 251.6, 252.2, 266.27]
...
legend_name = ["Flowcut Switching MPR Default", "Flowcut Switching MPR Check Port", "Flowcut Switching Check Length + Port"]
...
barlist = ax.plot(x_pos, slingshot, alpha=sharedValues.alpha_bar_plots, marker='o', label=legend_name[0])
barlist = ax.plot(x_pos, slingshot_1, alpha=sharedValues.alpha_bar_plots, marker='o', label=legend_name[1])
barlist = ax.plot(x_pos, slingshot_2, alpha=sharedValues.alpha_bar_plots, marker='o', label=legend_name[2])
