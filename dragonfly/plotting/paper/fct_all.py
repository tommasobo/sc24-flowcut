...
ecmp = [321, 325, 329, 362, 379]
adaptive = [149, 157.675, 179.4, 189, 194]
valiant = [444, 454, 468, 498, 517]
flowlet_switching = [267, 284, 287.2, 296, 301]
flowchip_switching = [289.5, 291.2, 300.6, 304.2, 318.27]
...
legend_name = ["ECMP", "UGAL-L", "Valiant", "Flowlet Switching", "Flowcut Switching Default", "Flowcut Switching MPR"]
