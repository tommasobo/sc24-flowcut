...
list_x_ugaal, list_y_ugaal = get_data_from_files("input_for_plots/parse/", "ugaal", "host")
list_x_valiant, list_y_valiant = get_data_from_files("input_for_plots/parse/", "valiant", "host")

#Global
list_x_global, list_y_global = get_data_from_files("input_for_plots/parse/", "minimal", "global")
list_x_global_ugal, list_y_global_ugal = get_data_from_files("input_for_plots/parse/", "ugal", "global")
list_x_global_ugaal, list_y_global_ugaal = get_data_from_files("input_for_plots/parse/", "ugaal", "global")
list_x_global_valiant, list_y_global_valiant = get_data_from_files("input_for_plots/parse/", "valiant", "global")

#Intra
list_x_intra, list_y_intra = get_data_from_files("input_for_plots/parse/", "minimal", "intra")
list_x_intra_ugal, list_y_intra_ugal = get_data_from_files("input_for_plots/parse/", "ugal", "intra")
list_x_intra_ugaal, list_y_intra_ugaal = get_data_from_files("input_for_plots/parse/", "ugaal", "intra")
list_x_intra_valiant, list_y_intra_valiant = get_data_from_files("input_for_plots/parse/", "valiant", "intra")
...
ax1.set_title("Average Throughput Hosts -> Router | Shift+1 10 MB", weight = 'bold',
    ...
    x = 0,
    y = 1.04)
ax2.set_title("Average Throughput GLOBAL | Shift+1 10 MB", weight = 'bold',
    horizontalalignment = 'left',
    x = 0,
    y = 1.04)
ax3.set_title("Average Throughput INTRA | Shift+1 10 MB", weight = 'bold',
    horizontalalignment = 'left',
    x = 0,
    y = 1.04)
...
ax2.plot(list_x_global, list_y_global, label="Minimal") # offset of -0.4
ax2.plot(list_x_global_ugal, list_y_global_ugal, label="UGAL") # offset of -0.4
ax2.plot(list_x_global_ugaal, list_y_global_ugaal, label="UGAL-Aries") # offset of -0.4
ax2.plot(list_x_global_valiant, list_y_global_valiant, label="Valiant") # offset of -0.4

ax3.plot(list_x_intra, list_y_intra, label="Minimal") # offset of -0.4
ax3.plot(list_x_intra_ugal, list_y_intra_ugal, label="UGAL") # offset of -0.4
ax3.plot(list_x_intra_ugaal, list_y_intra_ugaal, label="UGAL-Aries") # offset of -0.4
ax3.plot(list_x_intra_valiant, list_y_intra_valiant, label="Valiant") # offset of -0.4
