...
list_bench = ["Random Perm\n(Enterprise)", "Random Perm\n(Web-search)", "Random Perm\n(Random distr.)", "All-to-all"]
...
data = [[1000, 50000],[5000,450000],[5000,100000],[100,1000],[2500,70150],[1750, 36800]]
...
ax.plot(2,2500,'o',zorder=3,color=sharedValues.color_timeout[1])
...
ax.plot(5,75000,'o',zorder=3,color=sharedValues.color_timeout[1])
...
ax.plot(8,25000,'o',zorder=3,color=sharedValues.color_timeout[1])
...
ax.plot(11,400,'o',zorder=3,color=sharedValues.color_timeout[1])
ax.plot(11,data[3][1],'o',zorder=3,color=sharedValues.color_timeout[0])


ax.xaxis.set_tick_params(labelsize=12.2)
ax.yaxis.set_tick_params(labelsize=12.2)
...
#plt.savefig(Path("plots1/png") / (str("timeout") + file_name))
#plt.savefig(Path("plots1/pdf") / (str("timeout") + file_name + ".pdf"))
