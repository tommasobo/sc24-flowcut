...
list_ports_global_valiant, list_ports_hosts_valiant, list_intra_valiant, num_r = get_data_from_files("input_for_plots/parse/", "valiant", plot_type)
...
create_subplot(ax_lst[3], "global", list_ports_global_valiant, X, "")   
create_subplot(ax_lst[4], "host", list_ports_hosts_valiant, X, "") 
create_subplot(ax_lst[5], "intra", list_intra_valiant, X, "") 

create_subplot(ax_lst[6], "global", list_ports_global_ugal, X, "")   
create_subplot(ax_lst[7], "host", list_ports_hosts_ugal, X, "") 
create_subplot(ax_lst[8], "intra", list_intra_ugal, X, "") 
...
ax3.text(33.5,28.5,"Minimal", size=16,
                           verticalalignment='center', rotation=270)
ax6.text(33.5,28.5,"Valiant", size=16,
                           verticalalignment='center', rotation=270)
ax9.text(33.5,28.5,"UGAL", size=16,
                           verticalalignment='center', rotation=270)
