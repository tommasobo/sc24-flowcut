...
# Create dataset
ugal = [-11,85.1,67.7,20.3,6.2,28.3]
flow = [-37.1,46,19.6,10.2,2.1,19.7]
sling = [-44.2,31.4,28.1,9,6.6,18.9]

ooo1 = [64, 56, 57, 13, 19, 24]
ooo2 = [3, 2, 4, 0, 4, 1]
ooo3 = [0, 0, 0, 0, 0, 0]
...
# Title and Labels
ax.set_title(
	label = "Runtime speedup compared to ECMP",
	weight = 'bold',
...
barlist = ax.barh(pos_y, ugal, width, color=sharedValues.color_background_traffic, alpha=sharedValues.alpha_bar_plots)
...
rects2 = ax.barh(pos_y2, flow, width, color=sharedValues.color_main_traffic, alpha=sharedValues.alpha_bar_plots)
rects3 = ax.barh(pos_y3, sling, width, color=sharedValues.color_extent, alpha=sharedValues.alpha_bar_plots)
