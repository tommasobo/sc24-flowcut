...
class NdpSrc : public PacketSink, public EventSource, public TriggerTarget {
  ...
  public:
    ...
    const Route *_route;
    static simtime_picosec flowlet_switching_value;
    static double flowcut_rtt_ratio;
    uint16_t last_flowlet_choice = 0;
    double exp_avg_rtt_flowcut = 0;
    static double exp_avg_alpha;
    simtime_picosec last_flowlet = 0;
    static std::string custom_routing;
    simtime_picosec last_pkt_send_time = 0;
    ...
    static void set_sc_routing(std::string value) { custom_routing = value; }
    static void set_flowcut_rtt_ratio(double value) { flowcut_rtt_ratio = value; }
    static void set_flowlet_alpha(double value) { exp_avg_alpha = value; }

    static void set_flowlet_gap(simtime_picosec value) { flowlet_switching_value = value; }
