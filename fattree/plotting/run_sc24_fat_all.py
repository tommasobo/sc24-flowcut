...
def run_experiment(experiment_name, experiment_cm, topo_name, name_title, msg_size):
    ...
    # MPRDMA
    out_name = "experiments/{}/out.txt".format(experiment_name)
    string_to_run = "../sim/datacenter/htsim_ndp_entry_modern -topo ../sim/datacenter/topologies/{} -o uec_entry -k 1 -nodes 128 -q 4452000 -strat ecmp_host_random_ecn -linkspeed 200000 -mtu 4096 -seed 15 -hop_latency 1000 -switch_latency 0 -os_border 1 -tm ../sim/datacenter/connection_matrices/{} -collect_data 0 -topology interdc -max_queue_size {} -interdc_delay 500000 -routing_sc flowlet -flowlet_value 990000 -cwnd 2500000 > {}".format(topo_name, experiment_cm, custom_queue_size, out_name)
    os.system(string_to_run)
    print(string_to_run)
    ...
    # MPRDMA2
    out_name = "experiments/{}/out.txt".format(experiment_name)
    string_to_run = "../sim/datacenter/htsim_ndp_entry_modern -topo ../sim/datacenter/topologies/{} -o uec_entry -k 1 -nodes 128 -q 4452000 -strat ecmp_host_random_ecn -linkspeed 200000 -mtu 4096 -seed 15 -hop_latency 1000 -switch_latency 0 -os_border 1 -tm ../sim/datacenter/connection_matrices/{} -collect_data 0 -topology interdc -max_queue_size {} -interdc_delay 500000 -routing_sc flowlet -flowlet_value 4080000 -cwnd 2500000 > {}".format(topo_name, experiment_cm, custom_queue_size, out_name)
    os.system(string_to_run)
    print(string_to_run)
    ...
    # Flowlet Balanced
    out_name = "experiments/{}/out.txt".format(experiment_name)
    string_to_run = "../sim/datacenter/htsim_ndp_entry_modern -topo ../sim/datacenter/topologies/{} -o uec_entry -k 1 -nodes 128 -q 4452000 -strat ecmp_host_random_ecn -linkspeed 200000 -mtu 4096 -seed 15 -hop_latency 1000 -switch_latency 0 -os_border 1 -tm ../sim/datacenter/connection_matrices/{} -collect_data 0 -topology interdc -max_queue_size {} -interdc_delay 500000 -routing_sc flowlet -flowlet_value 1580000 -cwnd 2500000 > {}".format(topo_name, experiment_cm, custom_queue_size, out_name)
    os.system(string_to_run)
    print(string_to_run)
...
def main():
    ...
    list_custom_names = ["FlowcutPaperPermOS"]
    list_topo = ["fat_tree_128_2os.topo"]
    list_exp = ["perm_128_t"]
