...
def run_experiment(experiment_name, experiment_cm, topo_name, name_title, msg_size):
    ...
    string_to_run = "../sim/datacenter/htsim_ndp_entry_modern -failure_link 80 -topo ../sim/datacenter/topologies/{} -o uec_entry -k 1 -nodes 128 -q 4452000 -strat ecmp_host_random_ecn -linkspeed 50000 -mtu 4096 -seed 15 -hop_latency 1000 -switch_latency 0 -os_border 1 -tm ../sim/datacenter/connection_matrices/{} -collect_data 0 -topology interdc -max_queue_size {} -interdc_delay 500000 -routing_sc random -cwnd 2500000 > {}".format(topo_name, experiment_cm, custom_queue_size, out_name)
    print(string_to_run)
    ...
    string_to_run = "../sim/datacenter/htsim_ndp_entry_modern -failure_link 80 -topo ../sim/datacenter/topologies/{} -o uec_entry -k 1 -nodes 128 -q 4452000 -strat ecmp_host_random_ecn -linkspeed 50000 -mtu 4096 -seed 15 -hop_latency 1000 -switch_latency 0 -os_border 1 -tm ../sim/datacenter/connection_matrices/{} -collect_data 0 -topology interdc -max_queue_size {} -interdc_delay 500000 -routing_sc ecmp -cwnd 2500000 > {}".format(topo_name, experiment_cm, custom_queue_size, out_name)
    ...
    # MPRDMA
    out_name = "experiments/{}/out.txt".format(experiment_name)
    string_to_run = "../sim/datacenter/htsim_ndp_entry_modern -failure_link 80 -topo ../sim/datacenter/topologies/{} -o uec_entry -k 1 -nodes 128 -q 4452000 -strat ecmp_host_random_ecn -linkspeed 50000 -mtu 4096 -seed 15 -hop_latency 1000 -switch_latency 0 -os_border 1 -tm ../sim/datacenter/connection_matrices/{} -collect_data 0 -topology interdc -max_queue_size {} -interdc_delay 500000 -routing_sc flowlet -flowlet_value 3550000 -cwnd 2500000 > {}".format(topo_name, experiment_cm, custom_queue_size, out_name)
    os.system(string_to_run)
    print(string_to_run)
    ...
    # MPRDMA2
    out_name = "experiments/{}/out.txt".format(experiment_name)
    string_to_run = "../sim/datacenter/htsim_ndp_entry_modern -failure_link 80 -topo ../sim/datacenter/topologies/{} -o uec_entry -k 1 -nodes 128 -q 4452000 -strat ecmp_host_random_ecn -linkspeed 50000 -mtu 4096 -seed 15 -hop_latency 1000 -switch_latency 0 -os_border 1 -tm ../sim/datacenter/connection_matrices/{} -collect_data 0 -topology interdc -max_queue_size {} -interdc_delay 500000 -routing_sc flowlet -flowlet_value 19550000 -cwnd 2500000 > {}".format(topo_name, experiment_cm, custom_queue_size, out_name)
    os.system(string_to_run)
    print(string_to_run)
    ...
    # Flowlet Balanced
    out_name = "experiments/{}/out.txt".format(experiment_name)
    string_to_run = "../sim/datacenter/htsim_ndp_entry_modern -failure_link 80 -topo ../sim/datacenter/topologies/{} -o uec_entry -k 1 -nodes 128 -q 4452000 -strat ecmp_host_random_ecn -linkspeed 50000 -mtu 4096 -seed 15 -hop_latency 1000 -switch_latency 0 -os_border 1 -tm ../sim/datacenter/connection_matrices/{} -collect_data 0 -topology interdc -max_queue_size {} -interdc_delay 500000 -routing_sc flowlet -flowlet_value 10550000 -cwnd 2500000 > {}".format(topo_name, experiment_cm, custom_queue_size, out_name)
    os.system(string_to_run)
    print(string_to_run)
    ...
    # EQDS
    out_name = "experiments/{}/out.txt".format(experiment_name)
    string_to_run = "../sim/datacenter/htsim_ndp_entry_modern -failure_link 80 -topo ../sim/datacenter/topologies/{} -o uec_entry -k 1 -nodes 128 -q 4452000 -strat ecmp_host_random_ecn -linkspeed 50000 -mtu 4096 -seed 15 -hop_latency 1000 -switch_latency 0 -os_border 1 -tm ../sim/datacenter/connection_matrices/{} -collect_data 0 -topology interdc -max_queue_size {} -interdc_delay 500000 -routing_sc flowcut -rtt_ratio 4 -cwnd 2500000 > {}".format(topo_name, experiment_cm, custom_queue_size, out_name)
    os.system(string_to_run)
    print(string_to_run)
    ...
    colors = ["#53b280"] * 10
    ax = sns.barplot(x=labels, y=averages, palette=colors)  # Setting ci=None disables the default error bars
    ...
    plt.ylabel('Flow Completion Time ({})'.format("ms"),fontsize=14.7)
    ...
    # Set labels and title
    plt.ylabel('Flow Completion Time 99th Tail ({})'.format("ms"),fontsize=14.7)
    #plt.xlabel('Congestion Control Algorithm',fontsize=17.5)
    ...
    ax3.set_yticklabels([int(i) for i in ax3.get_yticks()], fontsize = 15)

    # Set labels and title
    plt.ylabel('Packets out-of-order (%)',fontsize=14.7)
    ...
    plt.ylabel('Flow Completion Time (ms)',fontsize=14.7)
...
def main():
    ...
    list_custom_names = ["Failure_Flowcut_Perm", "Failure_Flowcut_Perm_Staggered", "Failure_Flowcut_Web", "Failure_Flowcut_Mining"]
    list_topo = ["fat_tree_128.topo", "fat_tree_128.topo", "fat_tree_128.topo", "fat_tree_128.topo"]
    list_exp = ["perm_128_2", "perm_128_t"]
