...
df['Y'] = df['Y'] / 100
sns.set(style="whitegrid")
plt.plot(df.iloc[::1, 0], df.iloc[::1, 1], linewidth=3.5,alpha=1, label='random')
...
plt.xlim(100, 300000000)  # Set x-axis limits
#plt.show()
plt.savefig('incast_paper_flowcut.pdf', bbox_inches='tight')
